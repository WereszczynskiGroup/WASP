...
g++ -c -O3 -march=native -std=gnu++14 mainFileGenTrajectories.cpp
g++ -O3 -march=native -std=gnu++14 -o polarWritheGenTrajectory point.o binaryFind.o getSections.o mutualWind2.o localWrithe.o mainFileGenTrajectories.o
