...
g++ -c -O3 -march=native -std=gnu++14 mainFileGenTrajectoriesStar.cpp
g++ -O3 -march=native -std=gnu++14 -o polarWritheGenTrajectoryStar point.o binaryFind.o getSections.o mutualWind2.o localWrithe.o mainFileGenTrajectoriesStar.o
