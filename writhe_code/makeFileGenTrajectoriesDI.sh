...
g++ -c -O3 -march=native -std=gnu++14 mainFileGenTrajectoriesDI.cpp
g++ -O3 -march=native -std=gnu++14 -o DIWritheGenTrajectory point.o binaryFind.o getSections.o mutualWind2.o localWrithe.o mainFileGenTrajectoriesDI.o
