...
g++ -c -O3 -march=native -std=gnu++14 mainFileGenTrajectoriesDIClosed.cpp
g++ -O3 -march=native -std=gnu++14 -o DIWritheGenTrajectoryClosed point.o binaryFind.o getSections.o mutualWind2.o localWrithe.o mainFileGenTrajectoriesDIClosed.o 
