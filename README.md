...
`python master_UI.py oxdna ../examples/plectoneme.oxdna 600 1 10 120 plectoneme_data 0 -pw -pws --smooth -ad -d --stride 10`
...
`python master_UI.py oxdna ../examples/plectoneme.oxdna 600 1 10 120 plectoneme_data 25 -pw -pws --smooth -d --stride 10`
